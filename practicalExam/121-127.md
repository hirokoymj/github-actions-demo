...
- [Practice Exam 121-127](#practice-exam-121-127)
	- [Q121: What’s true about default variables? (choose three)](#q121-whats-true-about-default-variables-choose-three)
			- [Default variables](#default-variables)
	- [Q122: What are the scopes defined for custom variables in a workflow? (choose three)](#q122-what-are-the-scopes-defined-for-custom-variables-in-a-workflow-choose-three)
			- [Custom variables](#custom-variables)
			- [Environment variable](#environment-variable)
			- [Summary](#summary)
	- [Q123: What must be added to actions/checkout if my-org/my-private-repo is a private repository differing from the one containing the current workflow?](#q123-what-must-be-added-to-actionscheckout-if-my-orgmy-private-repo-is-a-private-repository-differing-from-the-one-containing-the-current-workflow)
	...
	- [Q125: At what levels can environment variables be defined ? (Choose three)](#q125-at-what-levels-can-environment-variables-be-defined--choose-three)
			- [✅ Correct answers (Choose three):](#-correct-answers-choose-three)
	- [Q126: How should a dependent job reference the output1 value produced by a job named job1 earlier in the same workflow?](#q126-how-should-a-dependent-job-reference-the-output1-value-produced-by-a-job-named-job1-earlier-in-the-same-workflow)
			- [💡 Why this is correct](#-why-this-is-correct-1)
			- [🧩 Example](#-example)
	- [Q127: Which workflow command syntax correctly sets an environment variable named 'API\_VERSION' with the value '2.1' for subsequent steps in a GitHub Actions job?](#q127-which-workflow-command-syntax-correctly-sets-an-environment-variable-named-api_version-with-the-value-21-for-subsequent-steps-in-a-github-actions-job)
