...
- [Practice Exam 81-90](#practice-exam-81-90)
  - [Q81: How can you reuse a defined workflow in multiple repositories? (Choose two.)](#q81-how-can-you-reuse-a-defined-workflow-in-multiple-repositories-choose-two)
  - [Q82: How can you ensure a job runs only on a specific branch?](#q82-how-can-you-ensure-a-job-runs-only-on-a-specific-branch)
  - [Q83: What does the needs keyword do in a GitHub Actions workflow?](#q83-what-does-the-needs-keyword-do-in-a-github-actions-workflow)
  ...
  - [Q85: What is the purpose of the `with` keyword in a GitHub Actions workflow?](#q85-what-is-the-purpose-of-the-with-keyword-in-a-github-actions-workflow)
  - [Q86: Which of the following GitHub Actions syntax is used to run multiple commands in a single step?](#q86-which-of-the-following-github-actions-syntax-is-used-to-run-multiple-commands-in-a-single-step)
  - [Q87: How can you cache dependencies to speed up workflow execution?](#q87-how-can-you-cache-dependencies-to-speed-up-workflow-execution)
  - [Q88: What does the matrix keyword do in a GitHub Actions workflow?](#q88-what-does-the-matrix-keyword-do-in-a-github-actions-workflow)
  - [Q89: Which of the following can be used to limit the number of concurrent jobs running in a GitHub Actions workflow?](#q89-which-of-the-following-can-be-used-to-limit-the-number-of-concurrent-jobs-running-in-a-github-actions-workflow)
  - [Q90: What is the default timeout for a GitHub Actions job?](#q90-what-is-the-default-timeout-for-a-github-actions-job)
...
```
- By creating a reusable action❌ -> Using a reusable action (via GitHub Actions) helps you reuse individual steps, not entire workflows.
- By copying the workflow file to each repository
- By using workflow templates✅
- By defining the workflow in a central repository✅
```
