...
- [Practice Exam 101-110](#practice-exam-101-110)
  - [Q102: Which context holds information about the event that triggered a workflow run?](#q102-which-context-holds-information-about-the-event-that-triggered-a-workflow-run)
  - [Q103: In GitHub Actions, if you define both branches and paths filter, what is the effect on the workflow execution?](#q103-in-github-actions-if-you-define-both-branches-and-paths-filter-what-is-the-effect-on-the-workflow-execution)
  - [Q104: What is the recommended practice for treating environment variables in GitHub Actions, regardless of the operating system and shell used?](#q104-what-is-the-recommended-practice-for-treating-environment-variables-in-github-actions-regardless-of-the-operating-system-and-shell-used)
  - [Q105: Which of the following statements accurately describes the behavior of workflow jobs referencing an environment's protection rules?](#q105-which-of-the-following-statements-accurately-describes-the-behavior-of-workflow-jobs-referencing-an-environments-protection-rules)
  - [Q106: What is the purpose of the restore-keys parameter in actions/cache in GitHub Actions?](#q106-what-is-the-purpose-of-the-restore-keys-parameter-in-actionscache-in-github-actions)
  - [Q107: Which variable would you set to true in order to enable step debug logging?](#q107-which-variable-would-you-set-to-true-in-order-to-enable-step-debug-logging)
  - [Q108: Which configuration is appropriate for triggering a workflow to run on webhook events related to check_run actions?](#q108-which-configuration-is-appropriate-for-triggering-a-workflow-to-run-on-webhook-events-related-to-check_run-actions)
  - [Q109: What is the purpose of the timeout-minutes keyword in a step?](#q109-what-is-the-purpose-of-the-timeout-minutes-keyword-in-a-step)
  - [Q110: Dave is creating a templated workflow for his organization. Where must Dave store the workflow files and associated metadata files for the templated workflow?](#q110-dave-is-creating-a-templated-workflow-for-his-organization-where-must-dave-store-the-workflow-files-and-associated-metadata-files-for-the-templated-workflow)
  - [Summary](#summary)
...
- name: Upload Failure test report
  if: steps.run-tests.outcome == 'failure' ❌ SKIPPED
  run: actions/upload-artifact@v3
  with:
    name: test-report
    path: test-reports.html
...
- enable step debug logging -> UI, `ACTIONS_STEP_DEBUG`=true
  - **Settings → Secrets and variables → Actions → New repository secret**
- a templated workflow -> `.github` repo
